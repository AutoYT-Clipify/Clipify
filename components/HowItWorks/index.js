            ...
            { (
                <div id="services" className="mt-[15rem] lg:mt-[10.5rem] px-[7rem] ">
                    ...
                    {howItWorksData?.map((i) => (
                        <div key={i?.id} className={i?.id === 1 ? `flex flex-col lg:flex-row justify-center gap-[0rem] my-[10rem]` : `flex flex-col lg:flex-row-reverse justify-center gap-[0rem] my-[3rem]`}>

  ...
  return (
    ...
    <p className='regular justify-center text-center m-auto lg:w-[55%]  lg:pr-[6rem]  text-[5rem]  lg:text-[1.8rem] text-[#5C5C5C]'>Step 2 out of 2</p>
      ...
      <div className='m-[10rem] flex gap-[4rem] justify-center'>
          <div onClick={()=>setGender('male')} className={gender === 'male' ? 'w-[20%] border-solid border-[2px] border-[#7B68EE] rounded-lg p-[1rem]' : 'w-[20%] border-solid border-[1px] border-[#CECECE] rounded-2xl p-[1rem]'}>
          ...
          <div onClick={()=>setGender('female')}  className={gender === 'female' ? 'w-[20%] border-solid border-[2px] border-[#7B68EE] rounded-lg p-[1rem]' : 'w-[20%] border-solid border-[1px] border-[#CECECE] rounded-2xl p-[1rem]'}>
